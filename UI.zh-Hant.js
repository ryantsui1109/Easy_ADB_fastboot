    ...
    content: [
      {
        title: "重啟到",
        name: "power-menu",
        content: [["input", "reboot_input", "其他模式"]],
      },
      {
      ...
      },
      {
        title: "將鏡像刷入分區",
        name: "flash-menu",
        content: [["input", "flash_input", "欲刷入的分區"]],
      },
      {
        title: "清除分區",
        name: "erase-menu",
      ...
      },
      {
        ...
        name: "flashing-menu",
        content: [["input", "flashing_input", "自訂指令"]],
      },
      {
        title: "執行 OEM 指令",
        name: "oem-menu",
        content: [["input", "oem_input", "自訂OEM指令"]],
      },
      {
        title: "切換 A/B 分區",
        name: "active-menu",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        content: [["input", "system-reboot_input", "其他模式"]],
      },
    ],
  },
];
